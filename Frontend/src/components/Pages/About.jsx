    ...
    <div>
        ...
        <div class="md:flex md:items-center md:justify-between my-10 gap-5">
            <div class="md:w-1/2 md:pr-12">
                <h1 class="text-4xl font-bold mb-4">About Our Company</h1>
        ...
        <div class="m-2 my-20">
          <h2 class="text-2xl text-center font-bold mb-5">Services</h2>
      ...
      <div class="m-2 my-20">
        <h2 class="text-2xl text-center font-bold mb-5">Target Market</h2>
        ...
        <div>
          <h1 class="text-2xl text-center font-bold mb-5">Team Member's</h1>
        </div>
        ...
        <div class="m-2 my-20">
            <h2 class="text-2xl text-center font-bold mb-5">Our Mission</h2>
            <p class="text-gray-700 leading-relaxed text-center">
