  ...
  <div class="bg-white text-sm overflow-hidden mt-10 shadow-md rounded-lg">
    <table class="min-w-full divide-y divide-gray-200">
      ...
      <div class=" bg-white divide-y divide-gray-200">
        <tr className=' flex '>
          <input placeholder='0000000' className=' px-12 py-4 text-sm outline-none text-center ' type="text" size="12" />
          <input placeholder='ABC' className=' px-9 text-sm outline-none text-center ' type="text" size="12" />
          <input placeholder='0' className=' px-3 text-sm outline-none text-center ' type="text" size="12" />
          <input placeholder='Rs. 00' className=' px-6 py-4 text-sm outline-none text-center ' type="text" size="12" />
          <input placeholder='Delivered' className=' px-2 text-sm outline-none text-center ' type="text" size="12" />
        ...
        <tr className=' flex '>
          <input placeholder='---' className=' px-12 py-4 text-sm outline-none text-center ' type="text" size="12" />
          <input placeholder='---' className=' px-9 text-sm outline-none text-center ' type="text" size="12" />
          <input placeholder='---' className=' px-3 text-sm outline-none text-center ' type="text" size="12" />
          <input placeholder='---' className=' px-6 py-4 text-sm outline-none text-center ' type="text" size="12" />
          <input placeholder='---' className=' px-2 text-sm outline-none text-center ' type="text" size="12" />
          <select id="countries" class=" ml-8 cursor-pointer text-sm block w-24 p-2.5 bg-white outline-none text-gray-700 py-1 px-2 leading-8 transition-colors  duration-200 ease-in-out">
          <option className=' text-center' selected>---</option>
          <option className=' text-center' value="">Delivered Succesfully</option>
          <option className=' text-center' value="">Pending</option>
